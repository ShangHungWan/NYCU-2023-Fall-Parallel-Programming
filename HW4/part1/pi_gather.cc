...
int main(int argc, char **argv)
{
    ...
    long long int number_in_circles[world_size];
    MPI_Gather(&private_number_in_circle, 1, MPI_LONG_LONG_INT, number_in_circles, 1, MPI_LONG_LONG_INT, 0, MPI_COMM_WORLD);
    ...
    if (world_rank == 0)
    {
        ...
        {
            number_in_circle += number_in_circles[i];
        }
